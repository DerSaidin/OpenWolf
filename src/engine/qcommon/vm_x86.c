...
int EmitCallProcedure(vm_t *vm, int sysCallOfs) {
	int jmpSystemCall, jmpBadAddr, retval;
...
void VM_Compile(vm_t *vm, vmHeader_t *header) {
	int op, maxLength, v, i, callProcOfsSyscall, callProcOfs, callDoSyscallOfs;
...
int VM_CallCompiled(vm_t *vm, int *args) {
	...
	void	*entryPoint;
	int		programCounter, programStack, stackOnEntry, *opStack, opStackOfs;
	byte	*image;
