...
void idMatX::Test( void ) {
	...
	*/
	...
	if ( !m1.Compare( m2, 1e-4f ) ) {
		Com_Warning( "idMatX::LowerTriangularInverse failed" );
	}
	...
	*/
	...
	if ( !m1.Compare( m2, 1e-4f ) ) {
		Com_Warning( "idMatX::UpperTriangularInverse failed" );
	}
	...
	*/
	...
	if ( !m1.IsIdentity( 1e-4f ) ) {
		Com_Warning( "idMatX::Inverse_GaussJordan failed" );
	}
	...
	*/
	...
	if ( !m1.Compare( m2, 1e-4f ) ) {
		Com_Warning( "idMatX::Inverse_UpdateRankOne failed" );
	}
	...
	*/
	...
	for ( offset = 0; offset < size; offset++ ) {
		...
		if ( !m1.Compare( m2, 1e-3f ) ) {
			Com_Warning( "idMatX::Inverse_UpdateRowColumn failed" );
		}
	}
	...
	*/
	...
	if ( !m1.Compare( m2, 1e-4f ) ) {
		Com_Warning( "idMatX::Inverse_UpdateIncrement failed" );
	}
	...
	*/
	...
	for ( offset = 0; offset < size; offset++ ) {
		...
		if ( !m1.Compare( m2, 1e-3f ) ) {
			Com_Warning( "idMatX::Inverse_UpdateDecrement failed" );
		}
	}
	...
	*/
	...
	if ( !original.Compare( m1, 1e-4f ) ) {
		Com_Warning( "idMatX::LU_Factor failed" );
	}
	...
	*/
	...
	if ( !m1.Compare( m2, 1e-4f ) ) {
		Com_Warning( "idMatX::LU_UpdateRankOne failed" );
	}
	...
	*/
	...
	for ( offset = 0; offset < size; offset++ ) {
		...
		if ( !m1.Compare( m2, 1e-3f ) ) {
			Com_Warning( "idMatX::LU_UpdateRowColumn failed" );
		}
	}
	...
	*/
	...
	if ( !m1.Compare( m2, 1e-4f ) ) {
		Com_Warning( "idMatX::LU_UpdateIncrement failed" );
	}
	...
	*/
	...
	for ( offset = 0; offset < size; offset++ ) {
		...
		if ( !m1.Compare( m2, 1e-3f ) ) {
			Com_Warning( "idMatX::LU_UpdateDecrement failed" );
		}
	}
	...
	*/
	...
	if ( !m1.IsIdentity( 1e-4f ) ) {
		Com_Warning( "idMatX::LU_Inverse failed" );
	}
	...
	*/
	...
	if ( !original.Compare( m1, 1e-4f ) ) {
		Com_Warning( "idMatX::QR_Factor failed" );
	}
	...
	*/
	...
	if ( !m1.Compare( m2, 1e-4f ) ) {
		Com_Warning( "idMatX::QR_UpdateRankOne failed" );
	}
	...
	*/
	...
	for ( offset = 0; offset < size; offset++ ) {
		...
		if ( !m1.Compare( m2, 1e-3f ) ) {
			Com_Warning( "idMatX::QR_UpdateRowColumn failed" );
		}
	}
	...
	*/
	...
	if ( !m1.Compare( m2, 1e-4f ) ) {
		Com_Warning( "idMatX::QR_UpdateIncrement failed" );
	}
	...
	*/
	...
	for ( offset = 0; offset < size; offset++ ) {
		...
		if ( !m1.Compare( m2, 1e-3f ) ) {
			Com_Warning( "idMatX::QR_UpdateDecrement failed" );
		}
	}
	...
	*/
	...
	if ( !m1.IsIdentity( 1e-4f ) ) {
		Com_Warning( "idMatX::QR_Inverse failed" );
	}
	...
	*/
	...
	if ( !original.Compare( m1, 1e-4f ) ) {
		Com_Warning( "idMatX::SVD_Factor failed" );
	}
	...
	*/
	...
	if ( !m1.IsIdentity( 1e-4f ) ) {
		Com_Warning( "idMatX::SVD_Inverse failed" );
	}
	...
	*/
	...
	if ( !original.Compare( m2, 1e-4f ) ) {
		Com_Warning( "idMatX::Cholesky_Factor failed" );
	}
	...
	*/
	...
	if ( !m1.Compare( m2, 1e-4f ) ) {
		Com_Warning( "idMatX::Cholesky_UpdateRankOne failed" );
	}
	...
	*/
	...
	for ( offset = 0; offset < size; offset++ ) {
		...
		if ( !m1.Compare( m2, 1e-3f ) ) {
			Com_Warning( "idMatX::Cholesky_UpdateRowColumn failed" );
		}
	}
	...
	*/
	...
	if ( !m1.Compare( m2, 1e-4f ) ) {
		Com_Warning( "idMatX::Cholesky_UpdateIncrement failed" );
	}
	...
	*/
	...
	for ( offset = 0; offset < size; offset += size - 1 ) {
		...
		if ( !m1.Compare( m2, 1e-3f ) ) {
			Com_Warning( "idMatX::Cholesky_UpdateDecrement failed" );
		}
	}
	...
	*/
	...
	if ( !m1.IsIdentity( 1e-4f ) ) {
		Com_Warning( "idMatX::Cholesky_Inverse failed" );
	}
	...
	*/
	...
	if ( !original.Compare( m2, 1e-4f ) ) {
		Com_Warning( "idMatX::LDLT_Factor failed" );
	}
	...
	*/
	...
	if ( !m1.Compare( m2, 1e-4f ) ) {
		Com_Warning( "idMatX::LDLT_UpdateRankOne failed" );
	}
	...
	*/
	...
	for ( offset = 0; offset < size; offset++ ) {
		...
		if ( !m1.Compare( m2, 1e-3f ) ) {
			Com_Warning( "idMatX::LDLT_UpdateRowColumn failed" );
		}
	}
	...
	*/
	...
	if ( !m1.Compare( m2, 1e-4f ) ) {
		Com_Warning( "idMatX::LDLT_UpdateIncrement failed" );
	}
	...
	*/
	...
	for ( offset = 0; offset < size; offset++ ) {
		...
		if ( !m1.Compare( m2, 1e-3f ) ) {
			Com_Warning( "idMatX::LDLT_UpdateDecrement failed" );
		}
	}
	...
	*/
	...
	if ( !m1.IsIdentity( 1e-4f ) ) {
		Com_Warning( "idMatX::LDLT_Inverse failed" );
	}
	...
	*/
	...
	if ( !m1.Compare( m2, 1e-4f ) ) {
		Com_Warning( "idMatX::Eigen_SolveSymmetricTriDiagonal failed" );
	}
	...
	*/
	...
	if ( !m1.Compare( m2, 1e-4f ) ) {
		Com_Warning( "idMatX::Eigen_SolveSymmetric failed" );
	}
	...
	*/
	...
	if ( !m1.Compare( m2, 1e-4f ) ) {
		Com_Warning( "idMatX::Eigen_Solve failed" );
	}
}
