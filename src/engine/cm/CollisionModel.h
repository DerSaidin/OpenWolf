...
===============================================================================
	...
	a position test and fills in the d3trace_t structure accordingly.
...
typedef struct {
	...
	class idMaterial		*material;		// surface material
...
public:
	...
	virtual cmHandle_t		SetupTrmModel( const class idTraceModel &trm, class idMaterial *material ) = 0;
	...
	virtual void			Translation( d3trace_t *results, const idVec3 &start, const idVec3 &end,
	...
	virtual void			Rotation( d3trace_t *results, const idVec3 &start, const idRotation &rotation,
								const idTraceModel *trm, const idMat3 &trmAxis, int contentMask,
								cmHandle_t model, const idVec3 &modelOrigin, const idMat3 &modelAxis ) = 0;
