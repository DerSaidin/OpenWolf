...
void S_AdpcmEncode(short indata[], char outdata[], int len, struct adpcm_state *state) {
	short          *inp;
	signed char    *outp;
	int             val, sign, delta, diff, step, valpred, vpdiff, index, outputbuffer, bufferstep;
...
void S_AdpcmDecode(const char indata[], short *outdata, int len, struct adpcm_state *state) {
	signed char    *inp;
	int             outp, sign, delta, step, valpred, vpdiff, index, inputbuffer, bufferstep;
...
int S_AdpcmMemoryNeeded(const wavinfo_t * info) {
	float	scale;
	int		scaledSampleCount, sampleMemory, blockCount, headerMemory;
