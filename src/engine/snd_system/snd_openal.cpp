...
qboolean S_AL_Init( soundInterface_t *si )
{
	...
	enumeration_all_ext = (qboolean)qalcIsExtensionPresent(NULL, "ALC_ENUMERATE_ALL_EXT");
	enumeration_ext = (qboolean)qalcIsExtensionPresent(NULL, "ALC_ENUMERATION_EXT");
